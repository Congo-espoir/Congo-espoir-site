  ...
  return (
    <article className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        {/* Back link */}
        <Link to="/actualites" className="inline-flex items-center gap-2 text-gray-500 hover:text-primary-700 text-sm font-medium mb-8 transition-colors">
        ...
        <div className="mt-12 p-6 bg-primary-50 rounded-2xl border border-primary-100">
          <p className="text-primary-800 font-semibold mb-3">Soutenez Congo Espoir</p>
          <p className="text-primary-600 text-sm mb-4">Rejoignez le mouvement et contribuez à la construction d'une RDC meilleure.</p>
          <div className="flex flex-wrap gap-3">
            <Link to="/adhesion" className="btn-primary text-sm py-2.5 px-5">
              Adhérer au parti
            </Link>
            <Link to="/actualites" className="inline-flex items-center gap-2 text-primary-700 font-medium text-sm hover:text-primary-900 transition-colors">
